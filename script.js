...
function toggleContrast() {
  ...
  document.querySelector(".toggle-contrast").classList.toggle("fa-sun");
  document.querySelector(".toggle-contrast").classList.toggle("fa-moon");
}
...
function contact(event) {
  ...
  emailjs
    ...
    .catch(() => {
      loading.classList.remove("contact-visible");
      alert(
        "The email service is temporarily unavailable. Please contact me directly on patelarnavm@gmail.com"
      );
    });
}
...
function closeInfo() {
  ...
  document
    ...
    .classList.remove("contact-visible");
  document
